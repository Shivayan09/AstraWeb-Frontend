    ...
    return (
        <div>
            ...
            <div className="box">
                ...
                <p className='text-[0.9rem] text-center text-gray-500 mb-10'>Professional landing pages that turn visitors into customers across various industries</p>
                <div className="boxes flex flex-col md:flex-row justify-center items-center gap-10">
